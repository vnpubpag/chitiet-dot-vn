const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rubik3d.BggjlsyK.js","_astro/preload-helper.CVfkMyKi.js"])))=>i.map(i=>d[i]);
import { _ as Ce } from "./preload-helper.CVfkMyKi.js";
let w;
let __tla = (async ()=>{
    let R, Y, Z, ee, ke, y, te, ue;
    w = [
        "U",
        "R",
        "F",
    ...
    function De(t) {
        ...
        for(let r = 0; r < 8; r++){
            let f = 0;
            for(; f < 3 && !o(s(W[r][f])); f++);
            const M = s(W[r][(f + 1) % 3]), m = s(W[r][(f + 2) % 3]);
    ...
    class Ze {
        ...
        async runSolve() {
            ...
            this.refs.solveBtn.disabled = !0, this.setStatus(We() ? "Đang giải..." : "Đang khởi tạo bộ giải (lần đầu mất vài giây)...", "loading");
            try {
    ...
    let x = null, h, b = {
        ...ke
    }, be = null, L = null, Le = null, ae = !1, l = null, B = "paint", v = [], u = 0, q = [], p = !1, O = null, S = null, z = null, G = null, K = null, U = null, $ = null, N = null, J = null, Q = null, j = null, I = null;
    function F(t) {
        x && (x.dataset.step = t);
    }
    function V() {
    ...
    async function ye() {
        !l || u >= v.length || l.isAnimating() || (await l.animateMove(v[u], Se()), u++, L?.setProgress(u), C(!0));
    }
    async function tt() {
        !l || u <= 0 || l.isAnimating() || (await l.animateMove(Ne(v[u - 1]), Se()), u--, L?.setProgress(u), C(!0));
    }
    function st(t) {
    ...
    async function nt() {
        ...
        for(u >= v.length && (u = 0), p = !0, k(); p && u < v.length && (await ye(), !!p);)await st(140);
        p = !1, k();
    }
    function ot() {
        l && (p = !1, k(), l.loadState(q.slice()), u = 0, L?.setProgress(0), C(!0));
    }
    async function rt(t) {
        B = "solution", v = t.moves, u = 0, q = h.facelets.slice(), l?.setPaintEnabled(!1), l?.loadState(q.slice()), L?.setProgress(0), F("solve"), C(!0);
    }
    function re() {
        const t = {}, e = new Set;
        for (const s of w){
    ...
    function it() {
        ...
        s && (be = new Ie(s, b)), l?.setPalette(b), l?.setPaintEnabled(!0), B = "paint", F("paint"), V(), H(), C(!1);
    }
    function we() {
        Pe(h), B = "paint", v = [], u = 0, p = !1, k(), L?.reset(), l?.loadState(h.facelets.slice()), V(), H(), C(!1);
    }
    function lt() {
    ...
    function at() {
        h = Fe(), B = "paint", v = [], u = 0, p = !1, k(), L?.reset(), l?.setPaintEnabled(!0), l?.loadState(h.facelets.slice()), V(), H(), C(!1), F("paint");
    }
    async function ut() {
        if (!z || l) return;
        const { createRubikRenderer: t } = await Ce(async ()=>{
            const { createRubikRenderer: e } = await import("./rubik3d.BggjlsyK.js").then(async (m)=>{
                await m.__tla;
                return m;
            });
            return {
    ...
    function ft() {
        ...
        b = re().palette, h = he(), O = i("rs-counts"), S = i("rs-validation"), z = i("rs-viewer"), G = i("rs-speed"), K = i("rs-playback"), U = i("rs-prev"), $ = i("rs-next"), N = i("rs-auto"), J = i("rs-auto-play"), Q = i("rs-auto-pause"), j = i("rs-reset-view"), I = i("rs-colors-continue");
        const t = dt();
        t && (L = new Ze(t, {
            getState: ()=>h,
            isValid: ()=>Le?.ok ?? !1,
        ...
        I?.addEventListener("click", it), i("rs-recolor")?.addEventListener("click", ct), i("rs-clear")?.addEventListener("click", lt), i("rs-example")?.addEventListener("click", at), U?.addEventListener("click", ()=>{
            ...
            nt();
        }), j?.addEventListener("click", ot), window.addEventListener("pagehide", ()=>{
            ze(), l?.dispose(), l = null;
        }), F("colors"), X(), ut();
    }
    function dt() {
