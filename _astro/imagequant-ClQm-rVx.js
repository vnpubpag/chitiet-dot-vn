...
let __tla = (async ()=>{
    ...
    }, n = `/_astro/imagequant_bg-BcMVf2Ny.wasm`, r = async (e = {}, t)=>{
        let n;
    ...
    function m(e, t) {
        ...
        return c().set(e, n / 1), p = e.length, n;
    }
    let h = null;
    function g() {
        return (h === null || h.byteLength === 0) && (h = new Int32Array(i.memory.buffer)), h;
    }
    function _(e) {
        return u[e];
    }
    ...
    b = class e {
        ...
        static new_image(e, t, n, r) {
            let a = m(e, i.__wbindgen_malloc), o = p, s = i.imagequant_new_image(a, o, t, n, r);
            return x.__wrap(s);
        }
        set_max_colors(e) {
            try {
        ...
        process(e) {
            try {
                ...
                var n = g()[s / 4 + 0], r = g()[s / 4 + 1], a = g()[s / 4 + 2];
                if (g()[s / 4 + 3]) throw y(a);
                var o = te(n, r).slice();
    ...
    x = class e {
        ...
        constructor(t, n, r, a){
            let o = m(t, i.__wbindgen_malloc), s = p, c = i.imagequantimage_new(o, s, n, r, a);
            return e.__wrap(c);
        }
    };
    S = function(e, t) {
        return f(Error(l(e, t)));
    };
    C = function(e, t) {
        throw Error(l(e, t));
    };
...
export { b as Imagequant, x as ImagequantImage, a as __wbg_set_wasm, S as __wbindgen_error_new, C as __wbindgen_throw, __tla };
