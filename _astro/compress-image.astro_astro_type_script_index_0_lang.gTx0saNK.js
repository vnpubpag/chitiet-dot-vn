const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/jszip.min.CJ7oMgXK.js","_astro/phaser.KZmhzKO7.js"])))=>i.map(i=>d[i]);
...
(async ()=>{
    ...
    T.addEventListener("click", async ()=>{
        const e = (await X(async ()=>{
            const { default: o } = await import("./jszip.min.CJ7oMgXK.js").then((i)=>i.j);
            return {
                default: o
            };
