const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/game.BzIO1I3L.js","_astro/phaser.KZmhzKO7.js"])))=>i.map(i=>d[i]);
    ...
    async function r(n, e, o) {
        ...
        try {
            const { createGame: i } = await d(async ()=>{
                const { createGame: l } = await import("./game.BzIO1I3L.js");
                return {
                    createGame: l
                };
            }, __vite__mapDeps([0,1]));
